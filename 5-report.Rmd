...
**Hover or click CTs for more info, zoom in/out, and toggle between the two choropleth layers (top right)**
```{r, echo=FALSE}
map_leaflet_perc30
```
...
# Appendix
The following visualizations were useful to explore the data but haven't been finalized.
...
Use the 'range slider' below the main plot to focus on range of interest.
...
many more renters face high housing cost pressures.
